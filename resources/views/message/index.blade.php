    ...
    <div style="background-color:#fff" class="col-md-3 pull-left">
        <div class="row" style="padding:10px">
            ...
            <div class="col-md-2 pull-right">
                <a href="#"><img src="{{Config::get('app.url')}}/public/img/compose.png" title="Send New Messages"></a></a>
            </div>
        </div>
        <div v-for="privsteMsg in privatemessages">
            ...
            <li v-else  @click="messages(privsteMsg.id)" style="list-style:none;margin-top:10px; background-color:#fff" class="row">
                <div class="col-md-3 pull-left">
                    <img :src="'{{Config::get('app.url')}}/public/img/' + privsteMsg.pic" style="width:50px; border-radius:100%; margin:5px">
                </div>
                <div class="col-md-9 pull-left" style="margin-top:5px">
                    <b> @{{privsteMsg.name}}</b><br>
                    <small>Gender: @{{privsteMsg.gender}}</small>
            ...
            <div v-for="singleMsg in singleMsgs" >
                <div v-if="singleMsg.user_from == <?php echo Auth::user()->id; ?>">
                    <div class="col-md-12" style="margin-top:10px">
                        <img :src="'{{Config::get('app.url')}}/public/img/' + singleMsg.pic" style="width:30px; border-radius:100%; margin-left:5px" class="pull-right">
                ...
                <div v-else>
                    <div class="col-md-12 pull-right"  style="margin-top:10px">
                        <img :src="'{{Config::get('app.url')}}/public/img/' + singleMsg.pic" style="width:30px; border-radius:100%; margin-left:5px" class="pull-left">
